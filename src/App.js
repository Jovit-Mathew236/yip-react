      ...
      <body>
        ...
        <nav className="navbar fixed-top navbar-expand-lg navbar-light">
          <div className="container-fluid">
            <a className="navbar-brand" href="https://mulearn.org">
              <img
                className="mulearn-logo"
                src={require("./assets/Mulearn.png")}
                alt=""
              />
            </a>
            ...
            >
              <div className="navbar-dropdowns"></div>
        ...
        <footer>
          <div className="footer-container">
            <div className="footer-top">
              <div className="fsection1">
                ...
                <div className="footer-links">
                  <a href="https://mulearn.org/careers">Careers</a>
                  <a href="https://gtechmulearn.medium.com/">Blog</a>
                  <a href="https://mulearn.org/events">Events</a>
                </div>

                <div className="social-links">
                  <a href="https://www.instagram.com/gtechmulearn/">
                    {/* <span className="iconify" data-icon="mdi:instagram"></span></a> */}
                    {/* <Icon className="iconify" id='car' color='#D71421' /> */}
                    <span className="bi bi-instagram iconify"></span>
                  </a>
                  <a href="https://twitter.com/GtechMulearn">
                    <span className="bi bi-twitter iconify"></span>
                  </a>
                  <a href="https://www.youtube.com/channel/UCuBrylE2ued66MJIMpuOSQg">
                    <i className=" bi bi-youtube iconify"></i>
                  </a>
                  <a href="https://www.linkedin.com/company/mulearn/">
                    <span className="bi bi-linkedin iconify"></span>
                  </a>
                  <a href="https://www.facebook.com/gtechmulearn">
                    <span className="bi bi-facebook iconify"></span>
                  </a>
                </div>
              </div>
              ...
              <div className="fsection2">
                <div className="newsletter">
                  <p className="fheadingtext">Join Our Mailing List</p>
                  <p className="fparagraph">
                    Join Our Mailing List Be the first to know about upcoming
                    coding workshops, new coding tools, and other Mulearn
                    related news.
                  </p>

                  <div className="invite-container">
                    <form
                      action="https://send.pageclip.co/Hb2In4aqXp2trmpkg0lU8nrg6Aya4rlL/YIP-Footer"
            ...
            <div className="address">
              ...
              <span className="mailus"> Contact Us: hi@mulearn.org </span>
            </div>
          </div>
        </footer>
      </body>
